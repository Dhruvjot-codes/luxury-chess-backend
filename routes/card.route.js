...
router.post('/', isAuth, isAdmin, uploadMultipleFiles, multerErrorHandler, asyncHandler(createCard));
// PUT with optional file upload
router.put('/:id', isAuth, isAdmin, uploadMultipleFiles, multerErrorHandler, asyncHandler(updateCard));
